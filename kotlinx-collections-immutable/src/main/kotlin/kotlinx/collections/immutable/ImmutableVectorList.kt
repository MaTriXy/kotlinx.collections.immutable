...
internal class ImmutableVectorList<out E> private constructor(private val impl: PVector<E>) : PersistentList<E>, ImmutableList<E> {
    ...
    override fun subList(fromIndex: Int, toIndex: Int): ImmutableVectorList<E> = wrap(impl.subList(fromIndex, toIndex))
